...
def main():
    ...
    # 初始化 command
    demo_g1.commands[:, 0:3] = demo_g1.env.unwrapped.command_manager.get_command("base_velocity")
    ...
    while simulation_app.is_running():
        ...
        # 写入 command buffer
        demo_g1.env.unwrapped.command_manager._commands["base_velocity"][:] = demo_g1.commands[:, 0:3]
