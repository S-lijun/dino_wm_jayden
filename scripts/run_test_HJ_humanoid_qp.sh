#!/usr/bin/env bash
# Test QP safety filter on Isaac G1 + DINO-WM.
#
# Usage:
#   bash scripts/run_test_HJ_humanoid_qp.sh runs/qp_hj_humanoid/.../epoch_id_N/policy.pth
#   MODE=waypoint_only bash scripts/run_test_HJ_humanoid_qp.sh <policy.pth>
