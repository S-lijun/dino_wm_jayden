...
def load_dreamer():
    import sys
    import pathlib
    sys.path.append("/storage1/fs1/sibai/Active/ihab/research_new/SafeDreamer/dreamerv3-torch/dreamerv3-torch")
    ...
    parser.add_argument("--seed_eval", "-s", type=int, default=0)
