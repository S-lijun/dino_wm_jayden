...
def main():
    ...
    if args.pid_only:
        video_save_path = f"/storage1/fs1/sibai/Active/ihab/research_new/dino_wm/close_loop/cargoal_{args.eps}/pid/"
    else:
        video_save_path = f"/storage1/fs1/sibai/Active/ihab/research_new/dino_wm/close_loop/cargoal_{args.eps}/{'dynamics' if args.only_dynamics else 'critic'}/{backbone}"
    # video_save_path = f"/storage1/fs1/sibai/Active/ihab/research_new/dino_wm/close_loop/cargoal/test"
