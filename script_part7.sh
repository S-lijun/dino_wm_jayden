...
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone vc1
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone dino_cls
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone r3m
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone resnet
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone dino
python test_cargoal_latent_specific_checkpoint_dynamics.py --backbone scratch
