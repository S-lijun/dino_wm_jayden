...
def load_latent_h(args):
    import hydra
    latent_h_path = f"/storage1/fs1/sibai/Active/ihab/research_new/checkpt_dino/classifier/mlp_with_gp/maniskill3000classif/scratch/with-proprio/failure_classifier.pth"
    args.freeze_wm = True
    ...
    ckpt_dir = Path(f"/storage1/fs1/sibai/Active/ihab/research_new/checkpt_dino/outputs2/maniskill/scratch")
...
def main():
    ...
    for backbone in backbones:
        ...
        wandb.finish()
# python /storage1/fs1/sibai/Active/ihab/research_new/dino_wm/test_yuxuan.py --seed 1 --task maniskill3000classif --epochs 2
